...
!function($) {
    ...
    $.fn.valid=function(object,options,cb){
        ...
        if(myoptions !=null && validationError){
            ...
            if(hadgroup)
            {
              myobject.parent().before('<span id="validerrmsg" class="zq-form-help-block" style="color: #FF0000;"><div class="alert alert-warning" role="alert" style="padding:10px;"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>'+myoptions+'</div></span>');
            }
            else {
              myobject.before('<span id="validerrmsg" class="zq-form-help-block" style="color: #FF0000;"><div class="alert alert-warning" role="alert" style="padding:10px;"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>'+myoptions+'</div></span>');
            };
        };
        //end
   ...
   $.fn.validation.defaults = {
    ...
    var validateField = function(field, valid) {
        ...
        if(form){
            ...
            if(fstyle == 0){
                el.after('<span class="zq-form-help-block" id="valierr">' + errorMsg +'</span>');
                if (globalOptions.icon===true ){
              ...
              if (globalOptions.icon===true ){
                ...
                el.parent().after('<span class="zq-form-help-block" id="valierr">' + errorMsg +'</span>');
                if (globalOptions.icon===true ){
                  if (el.find('option').length==0){
                    el.after('<span class="glyphicon '+ iconname +' form-control-feedback" aria-hidden="true"></span>');
                  }
                ...
                $(obj).find('input, textarea,select').each(function(){
                    ...
                    if (valid){
                        if ($.inArray('required',valid)>=0){
                            el.parent().after('<span class="zq-form-help-block" id="valierr" style="color:#FF9966">*</span>');
                        }
                    };
                }); 
            };
